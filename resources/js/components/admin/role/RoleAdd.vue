  ...
  <div class="br-section-wrapper">
    <div class="row">
      <div class="col-6">
        ...
        <h6 class="br-section-label">Admin Add</h6>
        <p class="br-section-text"></p>
      </div>
      <div class="col-6">
       <a :href="'/admin/admins'" class="btn btn-primary float-right">Admin Add</a>
      </div>
    </div>
    <form  @submit.prevent="addAdmin" :action="'admin/profile/update'" method="POST" enctype="multipart/form-data">
      ...
      <div class="row mg-b-25">
	        ...
	        <div class="col-lg-12">
	          <div class="form-group">
	            ...
	            <input class="form-control" type="password"  v-model="admin.password" name="password" placeholder="Enter Password" value="" required>
	        ...
	        <div class="col-lg-6 col-sm-12 btn-">
	          <div class="form-group">
	    ...
	    </div>                    <img class="img-responsive" alt="" src="{{ $step->image ? asset($step->image) : asset('/uploads/blank.png') }}" width="250px">
