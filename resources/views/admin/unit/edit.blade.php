...
<div class="br-pageheader">
  <nav class="breadcrumb pd-0 mg-0 tx-12">
    ...
    <span class="breadcrumb-unit active">Edit</span>
  </nav>
</div><!-- br-pageheader -->
<div class="br-pagetitle">
  <i class="fa fa-industry" aria-hidden="true"></i>
  <div>
    <h4 class=" text-capitalize">unit Edit</h4>
    <p class="mg-b-0"></p>
  </div>
</div><!-- d-flex -->
  ...
  <div class="br-section-wrapper">
    <div class="row">
      <dib class="col-6">
        ...
        <h6 class="br-section-label  text-capitalize">unit Edit</h6>
      ...
      <div class="row mg-b-25">
        <div class="col-lg-12">
          <div class="form-group row">
            ...
            <input class="form-control" type="text" name="name" value="{{ $unit->name }}" placeholder="Enter Name"  required>  
            @error('name')
        ...
        <div class="col-lg-6">
          <div class="form-group">
            ...
            <input class=""  type="checkbox" name="status" @if($unit->status==1) checked @endif value="1">
            @error('status')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
