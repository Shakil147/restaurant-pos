...
<div class="d-flex align-items-center justify-content-center bg-br-primary ht-100v">
      ...
      <div class="login-wrapper wd-300 wd-xs-350 pd-25 pd-xs-40 bg-white rounded shadow-base">
        <div class="signin-logo tx-center tx-28 tx-bold tx-inverse"><img src="{{ asset('web') }}/images/interface/logo.png" width="200" alt=""></div>
    ...
    <div class="form-group">
        ...
        <button type="submit" class="btn btn-info btn-block">{{ __('Reset Password') }}</button>
         <div class="mg-t-10 tx-center"><a href="{{ route('login') }}" class="tx-info tx-12 d-block mg-t-10">{{ __('Login') }}</a></div>
         </form>
      </div><!-- login-wrapper -->
    </div><!-- d-flex -->
@endsection
