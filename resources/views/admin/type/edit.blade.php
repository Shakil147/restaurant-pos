...
<div class="br-pagetitle">
  ...
  <div>
    <h4 class=" text-capitalize">type Edit</h4>
    <p class="mg-b-0"></p>
  </div>
</div><!-- d-flex -->
  ...
  <div class="br-section-wrapper">
    <div class="row">
      <dib class="col-6">
        ...
        <h6 class="br-section-label  text-capitalize">type Edit</h6>
      ...
      <div class="row mg-b-25">
        ...
        <div class="col-lg-12">
          <div class="form-group row">
            ...
            @if($type->image!=null)
            <div class="col-6">
              <img src="{{ asset($type->image) }}" alt="" width="80px" class="rounded">
            </div>
            @endif
        ...
        <div class="col-lg-6">
          <div class="form-group">
            ...
            <input class=""  type="checkbox" name="status" @if($type->status==1) checked @endif value="1">
            @error('status')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
