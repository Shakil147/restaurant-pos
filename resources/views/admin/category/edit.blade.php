      ...
      <div class="row mg-b-25">
        ...
        <div class="col-lg-12">
          <div class="form-group row">
            ...
            <div class="col-6">
              <img src="{{ asset($category->image) }}" alt="" width="80px" class="rounded">
            </div>
            @endif
        ...
        <div class="col-lg-6">
          <div class="form-group">
            ...
            <input class=""  type="checkbox" name="show_individual" @if($category->show_individual==1) checked @endif value="1">
        ...
        <div class="col-lg-6">
          <div class="form-group">
            ...
            <input class=""  type="checkbox" name="status" @if($category->status==1) checked @endif value="1">
            @error('status')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
